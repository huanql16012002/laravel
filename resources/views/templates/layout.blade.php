                ...
                <ul class="nav navbar-nav">
                    <li class="dropdown user user-menu">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                            <img src="/img/{{$objUser->hinh_anh_nv}}" class="user-image" alt="User Image">
                            <span class="hidden-xs">{{$objUser->ten_nhan_vien}} </span>
                        </a>
                        <ul class="dropdown-menu">
                            <li>
                                <p style="padding: 5px;">
                                    <i class="fa fa-at"></i> Email: {{ $objUser->email }}<br>
                                </p>
                                <p style="padding: 5px;">
                                    <i class="fa fa-map"></i> Địa chỉ: {{ $objUser->dia_chi }}<br>
                                </p>
                                <p style="padding: 5px;">
                                    <i class="fa fa-user"></i> Chức vụ: {{ $objUser->chuc_vu }}<br>
                                </p>
                            </li>
        ...
        <section class="sidebar">
            ...
            <div class="user-panel">
                <div class="pull-left image">
                    <img src="/img/{{$objUser->hinh_anh_nv}}" class="img-circle" alt="User Image">
                </div>
            ...
            <ul class="sidebar-menu" data-widget="tree">
                <li class=" active menu-open ">
                    <a href="{{url('/index')}}"><i class="fa fa-user"></i> <span>Quản lý nhân viên</span></a>
                    <a href="{{url('/phong')}}"><i class="fa fa-user"></i> <span>Quản lý phòng</span></a>
                    <a href="{{url('/khachhang')}}"><i class="fa fa-user"></i> <span>Quản lý khách hàng</span></a>
                </li>
            </ul>
        </section>
        <!-- /.sidebar -->
