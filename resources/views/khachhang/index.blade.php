                ...
                <div class="double-scroll">
                    <table class="table table-bordered">
                        <tr>
                            ...
                            <th class="text-center">Thẻ căn cước</th>  
                            ...
                            <tr>
                                ...
                                <td class="text-center"><a style="color:#333333;font-weight: bold;" href="" style="white-space:unset;text-align: justify;"> {{$item->ten_khach_hang}}</a></td>
                                <td class="text-center">{{$item->scmt}}</td>  
                                <td class="text-center">{{$item->sdt}}</td>         
                                <td class="text-center">{{$item->dia_chi}}</td>
                                <td class="text-center">{{$item->tuoi}}</td>
                                <td class="text-center">{{$item->ngay_thue}}</td>
                                <td class="text-center">{{$item->ngay_tra}}</td>
                                <td class="text-center"><a href="{{ route('route_BackEnd_Khachhang_Detail',$item->id) }}">Sửa</a></td>
                            </tr>
                            @endforeach
                    </table>
                </div>
